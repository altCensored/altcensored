...
#        flash(Markup(FLASH_MSG), 'error')
    ...
    FLASH_MSG = '<a href=' + video_url_download + ' class="alert-link" target="_blank" rel="noopener noreferrer" span style="color: darkorange;">Download<a> preferred videos, Internet Archive is <a href=https://archive.org/details/youtube-vf9dcSgtE5I class="alert-link" target="_blank" rel="noopener noreferrer" span style="color: darkorange;">limiting access on some items</a>'
